...
class CorePCGrad(nn.Module):
    ...
    def __init__(
        ...
        self.actor_optimizer = PCGradOptim(self.sac_agent.actor_optimizer)

        self.critic_optimizer = PCGradOptim(self.sac_agent.critic_optimizer)
