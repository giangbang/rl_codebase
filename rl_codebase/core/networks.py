...
class MLP(nn.Module):
    ...
    :param activation_fn: activation function used in MLP, we use by default the Tanh function as reported in
        https://arxiv.org/abs/2006.05990
    """

    def __init__(self, inputs_dim: int, outputs_dim: int, n_layer: int, n_unit: int = 256, activation_fn=nn.Tanh):
        super().__init__()
